          ...
          <Grid container className="main-main-blogs">
            <Grid items lg={6}>
              <div className="blog-main-div">
                ...
                <p className="blog-description-heading">
                  Morpheus8 is a micro-needling device that utilizes radio
                  frequency energy to remodel and contour the face and body.
                  This fractional treatment penetrates deep into the skin and
                  fat for a smoother…
                </p>
                <div className="contactus-btn-div">
                  <Link to="/services/face-and-neck">
                    {" "}
                    <Button
            ...
            <Grid items lg={6}>
              <div className="blog-main-div">
                ...
                <p className="blog-description-heading">
                  Morpheus8 (M8) Body is the latest radio frequency
                  micro-needling technology FDA approved for deep tissue
                  remodeling. This minimally -invasive treatment tightens skin,
                  liquefies fat, and reduces the…
                </p>
                <div className="contactus-btn-div">
                  <Link to="/services/body-tightening">
                    {" "}
                    <Button
                      className="blog-contact-btn"
                      onClick={handleReadMoreClick}
            ...
            <Grid items lg={6}>
              <div className="blog-main-div">
                ...
                <p className="blog-description-heading">
                  Morpheus8 focuses on skin reconstruction, increased collagen
                  and elastin formation, as well as improved skin cell turnover,
                  which helps to reduce the appearance of acne scars, surgical
                  scarring…more
                </p>
                <div className="contactus-btn-div">
                  <Link to="/services/body-scarring">
                    {" "}
                    <Button
                      className="blog-contact-btn"
                      onClick={handleReadMoreClick}
            ...
            <Grid items lg={6}>
              <div className="blog-main-div">
                ...
                <p className="blog-description-heading">
                  Improve skin appearance. With CryoToning® treatments, cold
                  temperatures boost collagen production, which tightens loose
                  skin, reduces the appearance of cellulite, and improves the…
                </p>
                <div className="contactus-btn-div">
                  <Link to="/services/body-toning">
                    {" "}
                    <Button
                      className="blog-contact-btn"
                      onClick={handleReadMoreClick}
              ...
              <>
                <Grid items lg={6}>
                  <div className="blog-main-div">
                    ...
                    <p className="blog-description-heading">
                      Unwanted Sun Spots, Age Spots , Pigmentation? Our Elite IQ
                      Laser is the best option for you! Great to treat Face,
                      Neck, Hands and much more...
                    </p>
                    <div className="contactus-btn-div">
                      <Link to="/services/Pigmentation">
                        {" "}
                        <Button
                          className="blog-contact-btn"
                          onClick={handleReadMoreClick}
                ...
                <Grid items lg={6}>
                  <div className="blog-main-div">
                    <p className="blog-main-heading">
                      Facial or Spider Vein Treatment{" "}
                    </p>
                    <p className="blog-description-heading">
                      Tired of stubborn facial and body spider Veins... Elite IQ
                      is the answer for you! Our noninvasive, focused,
                      heat-based treatment…
                    </p>
                    <div className="contactus-btn-div">
                      <Link to="/services/facial-spidervein-treatment">
                        {" "}
                        <Button
                          className="blog-contact-btn"
                          onClick={handleReadMoreClick}
                ...
                <Grid items lg={6}>
                  <div className="blog-main-div">
                    ...
                    <p className="blog-description-heading">
                      Reduce fine lines and wrinkles. CryoFacial treatments use
                      cold temperatures to increase blood flow and oxygen, which
                      boosts collagen production, reduces the appearance of
                      wrinkles and pores and…
                    </p>
                    <div className="contactus-btn-div">
                      <Link to="/services/cryo-facial">
                        {" "}
                        <Button
                          className="blog-contact-btn"
                          onClick={handleReadMoreClick}
                ...
                <Grid items lg={6}>
                  <div className="blog-main-div">
                    ...
                    <p className="blog-description-heading">
                      The Elite iQ device offers quick, easy and personalized
                      laser hair treatments using smart technology. The Elite iQ
                      device is equipped with the FDA-cleared Skintel melanin
                      reader. The Skintel device is…
                    </p>
                    <div className="contactus-btn-div">
                      <Link to="/services/LaserHairRemoval">
                        {" "}
                        <Button
                          className="blog-contact-btn"
                          onClick={handleReadMoreClick}
                ...
                <Grid items lg={6}>
                  <div className="blog-main-div">
                    ...
                    <p className="blog-description-heading">
                      Reduce fat and lose inches. During CryoSlimming®
                      treatments the skin is warmed then rapidly cooled. We
                      recommend 5-10 sessions for best results. On average,
                      people see 18.96% fat reduction in…
                    </p>
                    <div className="contactus-btn-div">
                      <Link to="/services/body-slimming">
                        {" "}
                        <Button
                          className="blog-contact-btn"
                          onClick={handleReadMoreClick}
                ...
                <Grid items lg={6}>
                  <div className="blog-main-div">
                    ...
                    <p className="blog-description-heading">
                      Our correction, prevention and nutrition system targets
                      fine lines and wrinkles, loss of elasticity and dull skin
                      for a firmer and more youthful appearance.
                    </p>
                    <div className="contactus-btn-div">
                      <Link to="/services/anti-aging-facial">
                        {" "}
                        <Button
                          className="blog-contact-btn"
                          onClick={handleReadMoreClick}
                ...
                <Grid items lg={6}>
                  <div className="blog-main-div">
                    ...
                    <p className="blog-description-heading">
                      This comprehensive brightening treatment combines the
                      latest innovationsin skin lightening technology to correct
                      all forms ofhyperpigmentation without drying the skin...
                    </p>
                    <div className="contactus-btn-div">
                      <Link to="/services/illuminating-facial">
                        {" "}
                        <Button
                          className="blog-contact-btn"
                          onClick={handleReadMoreClick}
                ...
                <Grid items lg={6}>
                  <div className="blog-main-div">
                    ...
                    <p className="blog-description-heading">
                      This comprehensive treatment combats all grades of acne,
                      combining powerful anti-bacterial peptides and salicylic
                      acid with soothing anti-inflammatory botanicals. perfect
                      for...
                    </p>
                    <div className="contactus-btn-div">
                      <Link to="/services/purifying-facial">
                        {" "}
                        <Button
                          className="blog-contact-btn"
                          onClick={handleReadMoreClick}
                ...
                <Grid items lg={6}>
                  <div className="blog-main-div">
                    ...
                    <p className="blog-description-heading">
                      We offer a Variety of Chemical Peels for your specific
                      concern. From Hyper Pigmentation, Acne, Skin tone and Much
                      More!
                    </p>
                    <div className="contactus-btn-div">
                      <Link to="/services/customized-chemicl-peel">
                        {" "}
                        <Button
                          className="blog-contact-btn"
                          onClick={handleReadMoreClick}
                ...
                <Grid items lg={6}>
                  <div className="blog-main-div">
                    ...
                    <p className="blog-description-heading">
                      Brow lamination is a process of perming your brow hairs,
                      but instead of curls, you get straighter, upward-facing
                      hairs that are set in place. It can help get rid of the
                      appearance of bare patches and irregular…
                    </p>
                    <div className="contactus-btn-div">
                      <Link to="/services/brow-lamination">
                        {" "}
                        <Button
                          className="blog-contact-btn"
                          onClick={handleReadMoreClick}
                ...
                <Grid items lg={6}>
                  <div className="blog-main-div">
                    ...
                    <p className="blog-description-heading">
                      A lash lift and tint is essentially a perm and color for
                      your eyelashes. This beauty treatment reshapes your
                      eyelashes making your straight lashes curl more noticeably
                      upward…
                    </p>
                    <div className="contactus-btn-div">
                      <Link to="/services/lash-lift-and-tint">
                        {" "}
                        <Button
                          className="blog-contact-btn"
                          onClick={handleReadMoreClick}
            ...
            <Button className="exploreMoreBtn" onClick={handleViewMoreClick}>
              {" "}
              {!showAllItems ? "Explore More" : "Close"}
            </Button>
          </Grid>
        </div>
      </div>
