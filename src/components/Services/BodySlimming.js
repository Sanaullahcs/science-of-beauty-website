...
import serviceImg from '../../assets/images/newServices9.png'
        ...
        <Grid container className='subServices-container '>
          <Grid items lg={6} md={6} sm={12} xs={12}>
            <div className='subServices-content-holder'>
              <div>
                <p className='subService-heading'>Body Slimming</p>
                <p className='subService-Description'>
                  Reduce fat and lose inches. During CryoSlimming® treatments the skin is warmed then rapidly cooled. We recommend 5-10 sessions for best results. On average, people see 18.96% fat reduction in treated areas.
                </p>
